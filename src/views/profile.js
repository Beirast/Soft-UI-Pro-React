      ...
      <div className="profile-profile">
        <div className="profile-container01">
          <div className="profile-container02">
            <h4 className="profile-text">Sierra</h4>
            <OutlineBlueButton button="follow"></OutlineBlueButton>
          </div>
          <div className="profile-container03">
            <span className="profile-text01">0 Posts</span>
            <span className="profile-text02">
              <span className="profile-text03">332</span>
              <span> Followers</span>
            </span>
            <span>
              <span className="profile-text06">649</span>
              <span> Following</span>
            </span>
          </div>
          ...
          <div className="profile-container05">
            <div className="profile-card">
              <div className="profile-container06">
                <h1 className="profile-text09">We have a discord!</h1>
                <span className="profile-text10">
                  Interested in meeting people with like interests and an equal
                  desire for hardware jank?
                </span>
                <div className="profile-container07">
                  <button className="profile-button button">
                    <span className="profile-text11">Click Here!</span>
      ...
      <div className="profile-contact">
        <div className="profile-container09">
          <div className="profile-form">
            <h2 className="profile-text12 HeadingOne">
              <span>Say Hi!</span>
            </h2>
            <span className="profile-text14 Lead">
              We&apos;d like to talk with you.
            </span>
            <form className="profile-form1">
              <label className="profile-text15 Label">My name is</label>
              <input
                type="text"
                placeholder="Full Name"
                className="profile-textinput Small input"
              />
              <label className="profile-text16 Label">
                I&apos;m looking for
              </label>
              <input
                type="text"
              ...
              />
              <label className="profile-text17 Label">Your message</label>
              <textarea
                rows="8"
          ...
          <div className="profile-info">
            ...
            <img alt="image" src="/wave-1.svg" className="profile-image" />
