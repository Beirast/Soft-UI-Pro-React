      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <span className="footer-gray-text">Xeon Phinatics</span>
          ...
          <div className="footer-gray-container4">
            <div className="footer-gray-container5">
              ...
              <span className="footer-gray-text04 Large">Nerd Resources</span>
              <span className="footer-gray-text05 Large">Blog</span>
            </div>
            <div className="footer-gray-container6">
              <span className="footer-gray-text06 Large">Resources</span>
              <span className="footer-gray-text07 Large">Login</span>
              <span className="footer-gray-text08 Large">Register</span>
            </div>
            <div className="footer-gray-container7">
              ...
              <a
                href="mailto:support@missile.gay?subject=Contact Form"
                className="footer-gray-link Large"
              >
                Contact Us
              </a>
              <span className="footer-gray-text10 Large">Knowledge Center</span>
        ...
        <span className="footer-gray-text12 Small">
          All rights reserved. Copyright © 2023 Xeon Phinatics
        </span>
      </div>
    </footer>
  )
